...
{
    // these never move
    // we create one per slot in a backpack or whatever type of container,
    // and each has a child Draggable that gets turned on or off.
    public class Slot : MonoBehaviour
    {
        ...
        // used by ObjectContainerArray and ObjectContainerList to
        // identify which element of the collection this Slot corresponds to
        [HideInInspector]
        public int index;
