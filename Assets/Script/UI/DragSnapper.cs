...
public class DragSnapper : UIBehaviour, IEndDragHandler, IBeginDragHandler
{
    ...
    public void OnBeginDrag(PointerEventData eventData) => StopCoroutine(SnapRect());

    // simply start our coroutine ( better than using update )
    public void OnEndDrag(PointerEventData eventData) => StartCoroutine(SnapRect());
